        ...
        <>
            ...
            {transportModes.map((mode) => (
              ...
              >
                ...
                {routeDetails[mode.id] && (
                  <span className="tab-time">{formatDuration(routeDetails[mode.id].duration)}</span>
                )}
              </button>
            ))}
          </div>
          ...
          <div className="map-container">
            ...
            >
              ...
              {/* Render all routes with different opacities */}
          ...
          <div className="route-details-panel">
            <div className="selected-route-info">
              ...
              <p className="route-description">{getModeConfig(selectedMode).description}</p>
              {routeDetails[selectedMode] && (
                <div className="route-stats">
                  <div className="stat">
                    <span className="stat-label">Duration:</span>
                    <span className="stat-value">{formatDuration(routeDetails[selectedMode].duration)}</span>
                  </div>
                  <div className="stat">
                    <span className="stat-label">Distance:</span>
                    <span className="stat-value">{routeDetails[selectedMode].distance} km</span>
                  </div>
                </div>
              )}
            </div>
